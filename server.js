...
client.on('ready', function(){ // Leaked by [ @M3a4x ]
    var ms = 30000 ;
    var setGame = [`$help | $inv `,` Legends Bot By Legends TeaM !`];
    var i = -1;
    var j = 0;
